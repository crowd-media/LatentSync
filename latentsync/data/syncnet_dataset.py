...
class SyncNetDataset(Dataset):
    ...
    def get_frames(self, video_reader: VideoReader, start_idx):
    ...
    def __getitem__(self, idx):
        ...
        for start_idx in range(len(vr)- self.num_frames):

            frames, wrong_frames= self.get_frames(vr, start_idx)
